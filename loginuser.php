...
<body>
    <h2>Halaman Login</h2>
    <form action="loginproses_us.php" method="post">
        <div class="mb-3 row">
        ...
        <button type="submit" class="btn btn-primary"name="daftar">Login</button>
<a href="halamanuser.php">
        <input type="button" class="btn btn-primary" value="Masuk Sebagai Anonim">
